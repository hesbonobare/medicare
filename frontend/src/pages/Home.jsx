...
import Doctor from './Doctors/DoctorsDetails';
    ...
    <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
      ...
      <div>
        <div className='lg:w-[570px]'>
          ...
          <p className='text__para'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt qui possimus fugiat reprehenderit quo nobis repellendus ab reiciendis pariatur optio.</p>
          <Link to='/doctors'>
      ...
      <div className='py-[30px] px-5'>
        ...
        <div className='mt-[30px]'>
          ...
          <p className='text-[16px] leading-7 text-textColor font-[400] mt-4 text-center'>
            World-class care for everyone.Our health system offers unmatched,expert health care.From the lab to the clinic</p>
...
<section>
  <div className="container">
    <div className='xl:w-[470px] mx-auto'>
      ...
      <p className='text__para text-center'>
        World-class care for everyone. Our health sysem offers unmatched,expert health care.
      </p>
    </div>
    ...
    <div className='flex items-center justify-between flex-col lg:flex-row'>
      ...
      <div className='xl:w-[670px]'>
        ...
        <ul className='pl-4'>
          ...
          <li className='text__para'>View our physicians who are accepting new patients ,use the online scheduling tool to select 
            an appointment time
          </li>
        </ul>
      ...
      <div className='relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0'>
        ...
        md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]'>
          ...
          <span className='w-5 h-5 lg:w-[34px] lg:h-[34px] flex items-center justify-end bg-yellowColor
